...
?>
	...
	<?php } else { ?>
	  <a href="#"  type="normal_logout" class="logout"><?php echo $language['log_out'];?><span> <img src="new/images/signout.png">  </span>  </a>    
	<?php } ?>
				</li> <?php } ?>
			</ul>     
		</div> 
...
<ul class="nav in side-menu">
       <?php if(isset($_SESSION['login'])){ ?>
        ...
        <?php } ?>
	   <?php } ?>
		<?php if(isset($profile_data['user_roles']) && $profile_data['user_roles'] ==  '2' && $profile_data['unrecognize_coin'] == 1) { ?>
			
		    <li><a href="partner_list.php"><span class="hide-menu"><?php echo $language["partner_list"];?></span></a></li>
        <?php } ?>
		 <?php if($profile_data['special_coin_name']){ ?>
		 <li>
			<a href="coinuserlist.php"><?php echo $profile_data['special_coin_name'];?></a>  </li><?php } ?>
			...
			<ul class="list-unstyled sub-menu collapse" aria-expanded="true">
			<li><a href="orderview.php"><?php echo $language["order_list"];?></a></li> 
			<li><a href="merchant_find.php"><?php echo $language["find_merchant"];?></a></li>
			
			<li><a href="favorite.php"><?php echo $language['fav_merchant'];?></a></li>
			<li><a href="orderlist.php"><?php echo $language['list_order_payment'];?></a></li>
			<li><a href="memberlist.php"><?php echo $language["refferal_member_list"];?></a></li> 
			<li><a href="set_workinghours.php"><?php echo $language["timing_working"];?></a></li> 
			<li><a href="offers.php"><?php echo $language['offers'];?></a></li>   
			<li><a href="report.php"><?php echo $language['report'];?></a></li> 
			<?php 
			...
			<li><a href="merchant_product.php"><?php echo $language['add_product']; ?></a></li>
        ...
        ?>   
				...
				<li><a href="view_product.php"><?php echo $language['view_product']; ?></a></li>
				<li><a href="product_order.php"><?php echo $language['product_order']; ?></a></li>
        ...
        <li class="menu-item-has-children">
			<a href="javascript:void(0);" class="ripple"><span class="color-color-scheme"><span class="hide-menu"><?php echo $language['category'];?></span></span></a>
			<ul class="list-unstyled sub-menu collapse" aria-expanded="true">
				<li><a href="add_category.php"><?php echo $language['add_category']; ?></a></li>
				<li><a href="add_mater_category.php"><?php echo $language['add_master']; ?></a></li>
				<li><a href="view_category.php"><?php echo $language['view_category']; ?></a></li>
				<li><a href="category_order.php"><?php echo $language['category_order']; ?></a></li>
			</ul>
        </li>
		 <li><a href="remark.php"><span class="hide-menu"><?php echo $language['remarks']; ?></span></a></li>
        <?php } 
        }?>
				 <li><a href="sub.php"><span class="hide-menu"><?php echo $language['subscriptions']; ?></span></a></li>
				 <li><a href="about_us.php"><span class="hide-menu"><?php echo $language['about_us']; ?></span></a></li>
<!--
...
--><li><a href="staff.php"><span class="hide-menu"><?php echo $language["staff"];?></span></a></li>
       ...
       <?php 
		...
		?>
					...
					{
					?>
						<li><a href="add_category.php"><?php  echo $language['ádd_category'];?></a></li>
					<?php } 
					
					if($addmasterper==1)
					{?>
						<li><a href="add_mater_category.php"><?php  echo $language['ádd_master'];?></a></li>
					<?php }
					if($viewcategoryper)
					{ ?>
						<li><a href="view_category.php"><?php  echo $language['view_master'];?></a></li>
					<?php } 
		...
		<?php }  ?>
        <?php if(isset($profile_data['user_roles']) && $profile_data['user_roles'] ==  '2' && $membership_plan_set == 1) { ?>
			
		    <li><a href="subscription.php"><span class="hide-menu"><?php echo $language["subscription_plan"];?></span></a></li>
        <?php } ?>
        <?php if(isset($profile_data['user_roles']) && $profile_data['user_roles'] ==  '2' && $coupon_offer == 1) { ?>
			
		    <li><a href="coupon_list.php"><span class="hide-menu"><?php echo $language["coupon_code_list"];?></span></a></li>
        <?php } ?>
		

		  <?php if(isset($profile_data['user_roles']) && $profile_data['user_roles'] ==  '2' && $profile_data['delivery_plan'] == 1) { ?>
			
		    <li><a href="deliveryplan.php"><span class="hide-menu"><?php echo $language["delivery_plan"];?></span></a></li>
        <?php } ?>
...
-->
       ...
       <li class="menu-item-has-children">
			...
			<ul class="list-unstyled sub-menu collapse" aria-expanded="true">
				...
				<li><a href="rebate.php"><?php echo $language['rebate'];?></a></li>  
				<?php } else { ?>
       ...
       <li><a href="profile.php"><span class="hide-menu"><?php echo $language['profile'];?></span></a></li>
		...
		<?php echo $language["download_app"] ?></span></a></li>  
         <?php if(isset($profile_data['user_roles']) && $profile_data['user_roles'] !=  '' && ($profile_data['user_roles'] !=  '5' || ($profile_data['user_roles'] ==  '5' && $ktypeper==1))) { ?>
...
<?php } ?>
      ...
      <?php  if(($profile_data['user_roles'] !=  '5' || ($profile_data['user_roles'] ==  '5' && $inverstorper==1)))
        ...
        <li><a href="investor_relations.php" class="investor_relation"><span class="hide-menu"><?php echo $language['InvestorRelations']; ?></span><i class='fa fa-star' style="color:yellow;"></i></a></li>
		<?php }

		if($profile_data['user_roles'] ==  '5' && $orderlistperm==1)
			{
		?>
		<li><a href="orderview-staff.php"><?php echo $language['order_list'];?></a></li> 
			<?php }
	...
	<?php } ?>
		...
		<li><a href="login.php"><span class="hide-menu"><?php echo $language['login'];?></span></a>	</li>
		<?php } ?>
    </ul>
    <!-- /.side-menu -->
<?php    
