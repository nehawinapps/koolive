    ...
    if ($orders->orders != null) {
        foreach ($orders->orders as $order) {
           ...
           $sql = "INSERT INTO `order_list` (`id`, `product_id`, `user_id`, `merchant_id`, `quantity`, `amount`, `wallet`, `created_on`, `location`, " .
                "`table_type`, `status`, `remark`, `invoice_no`, `popup`, `product_code`, `status_change_date`, `section_type`,`varient_type`,`order_place`,`user_name`,`user_mobile`) " .
                ...
                "'{$order->remark}', '{$order->invoice_no}', '{$order->popup}', '{$order->product_code}', '{$order->status_change_date}', '{$order->section_type}','{$order->varient_type}','{$order->order_place}','{$order->user_name}','{$order->user_mobile}')";
