...
$m_data=mysqli_query($conn,"select users.name, users.mobile_number, order_list.* from order_list INNER JOIN users ON users.id = order_list.user_id where order_list.user_id = '$member_user_id' and order_list.membership_plan_id != '0' and order_list.merchant_id='$merchant_id' and created_on>='$created_date'");
            ...
            <main class="main-wrapper clearfix" style="min-height: 522px;">
                ...
                <div class="row" id="main-content" style="padding-top:25px">
					<?php
						...
						$local_coin=mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(local_coin) as local_coin FROM local_coin_sync WHERE user_mobile='$mobile_number' and merchant_id='$merchant_id'"))['local_coin'];
						$plan_name=mysqli_fetch_assoc(mysqli_query($conn, "select  plan_name from membership_plan where id='$promo_id'"))['plan_name'];
						$total_amount=mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(total_cart_amount) as total_amount FROM order_list WHERE user_id='$user_id' and merchant_id='$merchant_id'"))['total_amount'];
						...
						$total_amount_after=mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(total_cart_amount) as total_amount FROM order_list WHERE user_id='$user_id' and merchant_id='$merchant_id' and created_on>='$created_date'"))['total_amount'];
