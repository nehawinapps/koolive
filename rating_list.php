...
{ 
	...
	mysqli_query($conn, "INSERT INTO  rating SET user_id='".$user_id."',merchant_id='".$merchant_id."',rating='".$rating."', comment='".$comment."',total='".$order_id."',Created_on='".$date."'");
