...
if(isset($_POST['signup']))
{
	...
	// echo $cm;
	$qu=mysqli_query($conn, "SELECT * FROM users WHERE mobile_number='$cm' && user_roles= '$user_role'");
	$already_exists1 = mysqli_num_rows($qu);
	 if($already_exists1 > 0)
	 {
		 $user_row2=mysqli_fetch_assoc($qu);
                        ...
                        <div class="resp-tabs-container">
                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
								...
								if(isset($error) && $error != "")
								{
									...
									<span class='alert alert-info' id="resend_link_label" style="display:none;font-size:12px;">Resend Link Shared to mobile Number</span>
									<?php }
								}
								?>  
								<br>
