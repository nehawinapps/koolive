...
$share_url="http://localhost/koolive/"."view_merchant.php?sid=".$sid."&vs=".md5(rand());
?>
<?php 
		if(isset($_GET['data']))
		{
...
<body  class="header-light sidebar-dark sidebar-expand pace-done">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <div>
            <div class="values label-pill bg-warning text-dark ">00:00:00</div>
          </div>
...
border: 1px solid #fa7953;background:red;color:black !important;margin-top: 3%;padding:10px;" href="index.php?vs=<?=md5(rand()) ?>"><?php echo $language['more_shops']; ?>
					...
					if($merchant_detail['mobile_number']==''){?>
						...
						window.location.replace("http://localhost/koolive/merchant_find.php");
...
<!-- winapps -->
    <h5>choose order date and time</h5>
    <input name="v-date" required="required"  type="date">
    <input name="v-time" required="required" type="time">
...
<div class="modal fade" id="voice_recognition" role="dialog">
  ...
  <script>
             ...
             success:function(response){
				 ...
				 var data = JSON.parse(JSON.stringify(response));
...

					{
					   ...
					   window.location.replace("http://localhost/koolive/orderlist.php");
   ...
   $("#paypal_close").click(function(e){    
      ...
      window.location.replace("http://localhost/koolive/view_merchant.php");
...

{
...

  {
	  ...
	  // window.location.replace("http://localhost/koolive/favorite.php");
  ...
  if(menu_type==2){
	...
	$("#no_button").click(function(e){
		var s_token=generatetokenno(6);
			var r_url="http://localhost/koolive/index.php?vs="+s_token;
